...
public class Grandmother extends Person{
    ...
    public Grandmother(int idPerson, String familyStatus, String firstName, String lastName, String gender, LocalDate birthdate, LocalDate deathdate, String biography, String eyesColor) {
